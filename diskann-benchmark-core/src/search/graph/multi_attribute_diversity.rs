...
use diskann_providers::model::graph::provider::async_::MultiAttributeDiversitySearchParams;
...
pub struct Parameters {
    ...
    pub processor: MultiAttributeDiversitySearchParams,
}

#[derive(Debug)]
pub struct MultiAttributeDiversity<DP, T, S>
where
...
impl<DP, T, S> MultiAttributeDiversity<DP, T, S>
where
    DP: provider::DataProvider,
{
    pub fn new(
...
impl<DP, T, S> Search for MultiAttributeDiversity<DP, T, S>
where
