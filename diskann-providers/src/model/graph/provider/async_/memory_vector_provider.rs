...
impl<T> diskann_record::save::Save for MemoryVectorProviderAsync<T>
where
    T: VectorRepr,
{
...
impl<T> diskann_record::load::Load<'_> for MemoryVectorProviderAsync<T>
where
    T: VectorRepr,
{
    const VERSION: diskann_record::Version = diskann_record::Version::new(0, 0, 0);
...
mod tests {
    ...
    type TestVectorProvider = MemoryVectorProviderAsync<f32>;
