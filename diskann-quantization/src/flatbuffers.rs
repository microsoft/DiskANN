...
//! Import the `flatbuffers` files generated by `tools/generate-flatbuffers.sh`.
//!
//! The generated module root does not support the lints applied to this crate, so this file
//! maintains a custom import tree around the generated bindings.
