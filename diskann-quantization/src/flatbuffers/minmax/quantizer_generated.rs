...
impl<'a> Quantizer<'a> {
  ...
  pub fn transform(&self) -> super::transforms::Transform<'a> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<super::transforms::Transform>>(Quantizer::VT_TRANSFORM, None).unwrap()}
  }
  #[inline]
  pub fn grid_scale(&self) -> f32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(Quantizer::VT_GRID_SCALE, Some(0.0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> QuantizerBuilder<'a, 'b, A> {
  ...
  pub fn add_transform(&mut self, transform: flatbuffers::WIPOffset<super::transforms::Transform<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<super::transforms::Transform>>(Quantizer::VT_TRANSFORM, transform);
  }
  #[inline]
  pub fn add_grid_scale(&mut self, grid_scale: f32) {
    self.fbb_.push_slot::<f32>(Quantizer::VT_GRID_SCALE, grid_scale, 0.0);
  }
  #[inline]
