...
impl<'a> Quantizer<'a> {
  ...
  pub fn quantizer(&self) -> SphericalQuantizer<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<SphericalQuantizer>>(Quantizer::VT_QUANTIZER, None).unwrap()
  }
  #[inline]
  pub fn nbits(&self) -> u32 {
    self._tab.get::<u32>(Quantizer::VT_NBITS, Some(0)).unwrap()
  }
}
...
pub struct QuantizerBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> QuantizerBuilder<'a, 'b> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> QuantizerBuilder<'a, 'b> {
...
pub fn get_root_as_quantizer<'a>(buf: &'a [u8]) -> Quantizer<'a> {
  unsafe { flatbuffers::root_unchecked::<Quantizer<'a>>(buf) }
}

#[inline]
#[deprecated(since="2.0.0", note="Deprecated in favor of `root_as...` methods.")]
pub fn get_size_prefixed_root_as_quantizer<'a>(buf: &'a [u8]) -> Quantizer<'a> {
  unsafe { flatbuffers::size_prefixed_root_unchecked::<Quantizer<'a>>(buf) }
}
...
#[inline]
pub fn finish_quantizer_buffer<'a, 'b>(
...
#[inline]
pub fn finish_size_prefixed_quantizer_buffer<'a, 'b>(fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>, root: flatbuffers::WIPOffset<Quantizer<'a>>) {
