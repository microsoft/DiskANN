...
impl<'a> Quantizer<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.quantizer {
            builder.add_quantizer(x);
        }
        builder.finish()
    }
    ...
    pub fn quantizer(&self) -> SphericalQuantizer<'a> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<SphericalQuantizer>>(
                    Quantizer::VT_QUANTIZER,
                    None,
                )
                .unwrap()
        }
...
impl flatbuffers::Verifiable for Quantizer<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<SphericalQuantizer>>(
                "quantizer",
                Self::VT_QUANTIZER,
                true,
            )?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> QuantizerBuilder<'a, 'b, A> {
    ...
    pub fn add_quantizer(&mut self, quantizer: flatbuffers::WIPOffset<SphericalQuantizer<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<SphericalQuantizer>>(
                Quantizer::VT_QUANTIZER,
                quantizer,
            );
    }
