...
impl<'a> SphericalQuantizer<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.centroid {
            builder.add_centroid(x);
        }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f32>>>(
                    SphericalQuantizer::VT_CENTROID,
                    None,
                )
                .unwrap()
        }
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<super::transforms::Transform>>(
                    SphericalQuantizer::VT_TRANSFORM,
                    None,
                )
                .unwrap()
        }
    ...
    pub fn metric(&self) -> SupportedMetric {
        ...
        unsafe {
            self._tab
                .get::<SupportedMetric>(
                    SphericalQuantizer::VT_METRIC,
                    Some(SupportedMetric::SquaredL2),
                )
                .unwrap()
        }
    }
    ...
    pub fn mean_norm(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(SphericalQuantizer::VT_MEAN_NORM, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn pre_scale(&self) -> f32 {
        ...
        unsafe {
            self._tab
                .get::<f32>(SphericalQuantizer::VT_PRE_SCALE, Some(0.0))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SphericalQuantizerBuilder<'a, 'b, A> {
    ...
    pub fn add_metric(&mut self, metric: SupportedMetric) {
        self.fbb_.push_slot::<SupportedMetric>(
            SphericalQuantizer::VT_METRIC,
            metric,
    ...
    pub fn add_mean_norm(&mut self, mean_norm: f32) {
        self.fbb_
            .push_slot::<f32>(SphericalQuantizer::VT_MEAN_NORM, mean_norm, 0.0);
    }
    #[inline]
    pub fn add_pre_scale(&mut self, pre_scale: f32) {
        self.fbb_
            .push_slot::<f32>(SphericalQuantizer::VT_PRE_SCALE, pre_scale, 0.0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> SphericalQuantizerBuilder<'a, 'b, A> {
    ...
    pub fn finish(self) -> flatbuffers::WIPOffset<SphericalQuantizer<'a>> {
        ...
        self.fbb_
            .required(o, SphericalQuantizer::VT_CENTROID, "centroid");
        self.fbb_
            .required(o, SphericalQuantizer::VT_TRANSFORM, "transform");
