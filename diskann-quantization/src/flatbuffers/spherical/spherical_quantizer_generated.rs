...
impl<'a> SphericalQuantizer<'a> {
  ...
  pub fn centroid(&self) -> flatbuffers::Vector<'a, f32> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f32>>>(SphericalQuantizer::VT_CENTROID, None).unwrap()
  }
  #[inline]
  pub fn transform(&self) -> super::transforms::Transform<'a> {
    self._tab.get::<flatbuffers::ForwardsUOffset<super::transforms::Transform>>(SphericalQuantizer::VT_TRANSFORM, None).unwrap()
  }
  #[inline]
  pub fn metric(&self) -> SupportedMetric {
    self._tab.get::<SupportedMetric>(SphericalQuantizer::VT_METRIC, Some(SupportedMetric::SquaredL2)).unwrap()
  }
  #[inline]
  pub fn mean_norm(&self) -> f32 {
    self._tab.get::<f32>(SphericalQuantizer::VT_MEAN_NORM, Some(0.0)).unwrap()
  }
  #[inline]
  pub fn pre_scale(&self) -> f32 {
    self._tab.get::<f32>(SphericalQuantizer::VT_PRE_SCALE, Some(0.0)).unwrap()
  }
}
...
pub struct SphericalQuantizerBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> SphericalQuantizerBuilder<'a, 'b> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> SphericalQuantizerBuilder<'a, 'b> {
