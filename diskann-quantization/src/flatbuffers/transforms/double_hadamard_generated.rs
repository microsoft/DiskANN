...
impl<'a> DoubleHadamard<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.signs1 {
            builder.add_signs1(x);
        }
        if let Some(x) = args.signs0 {
            builder.add_signs0(x);
        }
        builder.finish()
    }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DoubleHadamardBuilder<'a, 'b, A> {
    ...
    pub fn add_signs0(&mut self, signs0: flatbuffers::WIPOffset<flatbuffers::Vector<'b, bool>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(DoubleHadamard::VT_SIGNS0, signs0);
    }
    #[inline]
    pub fn add_signs1(&mut self, signs1: flatbuffers::WIPOffset<flatbuffers::Vector<'b, bool>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(DoubleHadamard::VT_SIGNS1, signs1);
    }
    #[inline]
    pub fn add_subsample(
        ...
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(DoubleHadamard::VT_SUBSAMPLE, subsample);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> DoubleHadamardBuilder<'a, 'b, A> {
