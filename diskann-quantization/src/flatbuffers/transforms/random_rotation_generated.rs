...
impl<'a> RandomRotation<'a> {
    ...
    pub fn nrows(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(RandomRotation::VT_NROWS, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn ncols(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(RandomRotation::VT_NCOLS, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RandomRotationBuilder<'a, 'b, A> {
    ...
    pub fn add_data(&mut self, data: flatbuffers::WIPOffset<flatbuffers::Vector<'b, f32>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(RandomRotation::VT_DATA, data);
    }
    #[inline]
    pub fn add_nrows(&mut self, nrows: u32) {
        self.fbb_
            .push_slot::<u32>(RandomRotation::VT_NROWS, nrows, 0);
    }
    #[inline]
    pub fn add_ncols(&mut self, ncols: u32) {
        self.fbb_
            .push_slot::<u32>(RandomRotation::VT_NCOLS, ncols, 0);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> RandomRotationBuilder<'a, 'b, A> {
