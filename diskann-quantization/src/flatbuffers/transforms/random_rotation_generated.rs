...
impl<'a> RandomRotation<'a> {
  ...
  pub fn data(&self) -> flatbuffers::Vector<'a, f32> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, f32>>>(RandomRotation::VT_DATA, None).unwrap()
  }
  #[inline]
  pub fn nrows(&self) -> u32 {
    self._tab.get::<u32>(RandomRotation::VT_NROWS, Some(0)).unwrap()
  }
  #[inline]
  pub fn ncols(&self) -> u32 {
    self._tab.get::<u32>(RandomRotation::VT_NCOLS, Some(0)).unwrap()
  }
}
...
pub struct RandomRotationBuilder<'a: 'b, 'b> {
  fbb_: &'b mut flatbuffers::FlatBufferBuilder<'a>,
  start_: flatbuffers::WIPOffset<flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b> RandomRotationBuilder<'a, 'b> {
  #[inline]
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>) -> RandomRotationBuilder<'a, 'b> {
