...
impl<'a> Transform<'a> {
    ...
    pub fn transform_type(&self) -> TransformKind {
        ...
        unsafe {
            self._tab
                .get::<TransformKind>(Transform::VT_TRANSFORM_TYPE, Some(TransformKind::NONE))
                .unwrap()
        }
    }
    #[inline]
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_union::<TransformKind, _>(
                ...
                true,
                |key, v, pos| match key {
                    TransformKind::RandomRotation => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<RandomRotation>>(
                            "TransformKind::RandomRotation",
                            pos,
                        ),
                    TransformKind::PaddingHadamard => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<PaddingHadamard>>(
                            "TransformKind::PaddingHadamard",
                            pos,
                        ),
                    TransformKind::DoubleHadamard => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<DoubleHadamard>>(
                            "TransformKind::DoubleHadamard",
                            pos,
                        ),
                    TransformKind::NullTransform => v
                        .verify_union_variant::<flatbuffers::ForwardsUOffset<NullTransform>>(
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TransformBuilder<'a, 'b, A> {
    ...
    pub fn add_transform_type(&mut self, transform_type: TransformKind) {
        self.fbb_.push_slot::<TransformKind>(
            Transform::VT_TRANSFORM_TYPE,
            transform_type,
            TransformKind::NONE,
        );
    }
    ...
    pub fn add_transform(
        ...
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(Transform::VT_TRANSFORM, transform);
    }
    #[inline]
