...
pub(crate) fn test_distance_function<Left, Right, LeftDist, RightDist, R>(
    checker: &mut dyn DistanceChecker<Left, Right>,
    left_dist: LeftDist,
...
mod test_test_utils {
    ...
    fn test_test_distance_function() {
        ...
        {
            let mut checker = Checker::<f32, f32, f32>::new(
                |left, right| {
    ...
    fn test_error_propagation() {
        let mut checker = AdHocChecker::<u8, u8>::new(|_, _| panic!("panic"));
