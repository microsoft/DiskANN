...
// AArch64 masks
use super::{
    Neon, f32x4, i8x8, i8x16, i16x8, i32x2, internal,
...
mod tests {
    ...
    test_utils::ops::test_splitjoin!(i32x4 => i32x2, 0xa4d00a4d04293967, test_neon());
    test_utils::ops::test_zipunzip!(i32x4 => i32x2, 0xb8f702ba85375041, test_neon());
