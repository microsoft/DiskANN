...
//! # How Does This Work?
//!
//! User error types (such as [`crate::provider::DataProvider::Error`])
//! are expected to implement [`ToRanked`], which converts the
...
//! and provides the `allow_transient`/`escalate` interface to these `Result`s.
//!
