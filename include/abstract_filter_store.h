...
template <typename LabelT> class AbstractFilterStore
{
  public:
    ...
    DISKANN_DLLEXPORT virtual bool point_has_label(location_t point_id, const LabelT label_id) const = 0;
    ...
    DISKANN_DLLEXPORT virtual void generate_random_labels(std::vector<LabelT> &labels, const uint32_t num_labels,
