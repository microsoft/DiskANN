...
template <typename T, typename LabelT = uint32_t>
DISKANN_DLLEXPORT int split_merged_vamana_index(std::string base_file, diskann::Metric _compareMetric, uint32_t L,
                                                uint32_t R, double sampling_rate, double ram_budget,
                                                std::string mem_index_path, std::string medoids_file,
                                                std::string centroids_file, size_t build_pq_bytes, bool use_opq,
                                                uint32_t num_threads, bool use_filters = false,
                                                ...
                                                const std::string &universal_label = "", const uint32_t Lf = 0);
template <typename T, typename LabelT = uint32_t>
DISKANN_DLLEXPORT int build_split_merged_vamana_index(std::string base_file, diskann::Metric _compareMetric, uint32_t L,
                                                uint32_t R, double sampling_rate, double ram_budget,
                                                std::string mem_index_path, std::string medoids_file,
                                                std::string centroids_file, size_t build_pq_bytes, bool use_opq,
                                                uint32_t num_threads, bool use_filters = false,
                                                const std::string &label_file = std::string(""),
                                                const std::string &labels_to_medoids_file = std::string(""),
                                                const std::string &universal_label = "", const uint32_t Lf = 0, const uint32_t subshard_id = 0);

template <typename T, typename LabelT = uint32_t>
DISKANN_DLLEXPORT int merge_split_vamana_index(std::string base_file, diskann::Metric _compareMetric, uint32_t L,
                                                      uint32_t R, double sampling_rate, double ram_budget,
                                                      std::string mem_index_path, std::string medoids_file,
                                                      std::string centroids_file, size_t build_pq_bytes, bool use_opq,
                                                      uint32_t num_threads, bool use_filters = false,
                                                      const std::string &label_file = std::string(""),
                                                      const std::string &labels_to_medoids_file = std::string(""),
                                                      const std::string &universal_label = "", const uint32_t Lf = 0, const uint32_t num_parts = 0);
...
template <typename T, typename LabelT = uint32_t>
DISKANN_DLLEXPORT int split_subgraph_index(
    const char *dataFilePath, const char *indexFilePath, const char *indexBuildParameters,
    diskann::Metric _compareMetric, bool use_opq = false,
    const std::string &codebook_prefix = "", // default is empty for no codebook pass in
    bool use_filters = false,
...
template <typename T, typename LabelT = uint32_t>
DISKANN_DLLEXPORT int build_subgraph_index(
    const char *dataFilePath, const char *indexFilePath, const char *indexBuildParameters,
    diskann::Metric _compareMetric, bool use_opq = false,
    const std::string &codebook_prefix = "", // default is empty for no codebook pass in
    bool use_filters = false,
    ...
    const std::string &universal_label = "", const uint32_t filter_threshold = 0,
    const uint32_t Lf = 0, 
    const uint32_t subshard_id = 0); // default is empty string for no universal label

template <typename T, typename LabelT = uint32_t>
DISKANN_DLLEXPORT int merge_subgraph_index(
    const char *dataFilePath, const char *indexFilePath, const char *indexBuildParameters,
    diskann::Metric _compareMetric, bool use_opq = false,
    const std::string &codebook_prefix = "", // default is empty for no codebook pass in
    bool use_filters = false,
    ...
    const uint32_t num_parts = 0); // default is empty string for no universal label
