...
public:
  ...
  DISKANN_DLLEXPORT virtual uint32_t
  ...
  preprocess_base_points(T *original_data, const size_t orig_dim,
...
public:
  ...
  DISKANN_DLLEXPORT virtual void
  preprocess_base_points(float *original_data, const size_t orig_dim,
                         const size_t num_points) override;

  DISKANN_DLLEXPORT virtual void
  preprocess_query(const float *query_vec, const size_t query_dim,
