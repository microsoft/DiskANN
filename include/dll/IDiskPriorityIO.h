...
struct AsyncReadRequest
{
    ...
    AsyncReadRequest() : m_offset(0), m_buffer(nullptr), m_readSize(0), m_payload(nullptr), m_success(false) {}
};
...
public:
    ...
    // TODO: need to figure out why ReadDataAsyncWithoutThreadPool didn't callback.
