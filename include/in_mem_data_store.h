...
public:
  InMemDataStore(const location_t capacity, const size_t dim,
  ...
  virtual void
  preprocess_query(const data_t *query,
                   AbstractScratch<data_t> *query_scratch) const override;

  virtual float get_distance(const data_t *preprocessed_query,
  ...
  virtual void
  get_distance(const data_t *preprocessed_query,
