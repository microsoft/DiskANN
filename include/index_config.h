...
enum class GraphStoreStrategy
{
    ...
    COMPRESSED_REFORMAT_STATICMEMORY,
    BITPACK_REFORMAT_STATICMEMORY,
    REORDER_COMPRESSED_REFORMAT_STATICMEMORY,
    STREAMVBYTE_REFORMAT_STATICMEMORY,
    REORDER_STREAMVBYTE_REFORMAT_STATICMEMORY,
    MASKEDVBYTE_REFORMAT_STATICMEMORY,
    LZ4_REFORMAT_STATICMEMORY
};
