...
template <typename T, typename LabelT = uint32_t> class PQFlashIndex
{
  public:
    ...
    DISKANN_DLLEXPORT std::unique_ptr<ANNErrorCode> cached_beam_search(const T *query, const uint64_t k_search,
    ...
    DISKANN_DLLEXPORT std::unique_ptr<ANNErrorCode> cached_beam_search(
