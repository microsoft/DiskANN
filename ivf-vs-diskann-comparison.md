...
### DiskANN vs IVF (nlist=316, baseline ≈ √N)
...
| **IVF-316** | nprobe=1 | 945.3 | 4,129µs | 7,336µs | 1.0 | 2,537µs | 1,592µs | 297 | ~1.85 MB (0.3%) | 24.59% |
| **IVF-316** | nprobe=4 | 308.1 | 12,977µs | 21,319µs | 4.0 | 8,830µs | 4,147µs | 1,175 | ~7.4 MB (1.3%) | 50.86% |
| **IVF-316** | nprobe=8 | 160.1 | 24,915µs | 38,780µs | 8.0 | 17,585µs | 7,330µs | 2,345 | ~14.8 MB (2.5%) | 65.28% |
| **IVF-316** | nprobe=16 | 83.8 | 47,490µs | 70,853µs | 16.0 | 34,095µs | 13,395µs | 4,727 | ~29.6 MB (5.1%) | 78.58% |
| **IVF-316** | nprobe=32 | 43.4 | 91,671µs | 128,222µs | 32.0 | 66,526µs | 25,145µs | 9,564 | ~59.2 MB (10.1%) | 89.05% |
| **IVF-316** | nprobe=64 | 21.1 | 188,822µs | 265,214µs | 64.0 | 137,899µs | 50,923µs | 19,415 | ~118.4 MB (20.2%) | **95.82%** |

### IVF nlist Comparison — OpenAI 100K

| nlist | nprobe | QPS | Mean Latency | P95 Latency | IOs | Mean IO Time | Mean CPU Time | Mean Comps | Bytes Read (est.) | Recall |
|-------|--------|-----|-------------|-------------|-----|-------------|--------------|------------|-------------------|--------|
| **158** | 1 | 585.1 | 6,804µs | 12,140µs | 1.0 | 4,605µs | 2,199µs | 587 | ~3.7 MB (0.6%) | 30.54% |
| **316** | 1 | 945.3 | 4,129µs | 7,336µs | 1.0 | 2,537µs | 1,592µs | 297 | ~1.9 MB (0.3%) | 24.59% |
| **632** | 1 | 1,390.4 | 2,862µs | 5,003µs | 1.0 | 1,054µs | 1,808µs | 158 | ~0.9 MB (0.2%) | 20.10% |
| **158** | 4 | 160.2 | 24,929µs | 39,192µs | 4.0 | 17,909µs | 7,020µs | 2,334 | ~14.8 MB (2.5%) | 60.35% |
| **316** | 4 | 308.1 | 12,977µs | 21,319µs | 4.0 | 8,830µs | 4,147µs | 1,175 | ~7.4 MB (1.3%) | 50.86% |
| **632** | 4 | 593.1 | 6,713µs | 12,022µs | 4.0 | 3,607µs | 3,106µs | 626 | ~3.7 MB (0.6%) | 43.31% |
| **158** | 8 | 79.0 | 50,602µs | 76,326µs | 8.0 | 36,923µs | 13,679µs | 4,673 | ~29.7 MB (5.1%) | 74.63% |
| **316** | 8 | 160.1 | 24,915µs | 38,780µs | 8.0 | 17,585µs | 7,330µs | 2,345 | ~14.8 MB (2.5%) | 65.28% |
| **632** | 8 | 335.7 | 11,912µs | 21,227µs | 8.0 | 7,199µs | 4,713µs | 1,237 | ~7.4 MB (1.3%) | 56.72% |
| **158** | 16 | 39.0 | 102,454µs | 150,434µs | 16.0 | 75,643µs | 26,811µs | 9,421 | ~59.3 MB (10.1%) | 86.48% |
| **316** | 16 | 83.8 | 47,490µs | 70,853µs | 16.0 | 34,095µs | 13,395µs | 4,727 | ~29.6 MB (5.1%) | 78.58% |
| **632** | 16 | 182.4 | 21,879µs | 37,217µs | 16.0 | 14,131µs | 7,748µs | 2,446 | ~14.8 MB (2.5%) | 69.85% |
| **158** | 32 | 19.5 | 204,136µs | 280,572µs | 32.0 | 151,407µs | 52,729µs | 19,166 | ~118.7 MB (20.3%) | 94.64% |
| **316** | 32 | 43.4 | 91,671µs | 128,222µs | 32.0 | 66,526µs | 25,145µs | 9,564 | ~59.2 MB (10.1%) | 89.05% |
| **632** | 32 | 92.1 | 43,265µs | 69,965µs | 32.0 | 29,242µs | 14,023µs | 4,865 | ~29.7 MB (5.1%) | 81.54% |
| **158** | 64 | 9.9 | 403,489µs | 492,080µs | 64.0 | 298,920µs | 104,569µs | 39,769 | ~237.4 MB (40.5%) | **98.74%** |
| **316** | 64 | 21.1 | 188,822µs | 265,214µs | 64.0 | 137,899µs | 50,923µs | 19,415 | ~118.4 MB (20.2%) | 95.82% |
| **632** | 64 | 47.7 | 83,858µs | 127,384µs | 64.0 | 57,688µs | 26,170µs | 9,740 | ~59.3 MB (10.1%) | 90.59% |
...
| **IVF-316** | nprobe=1 | 962.5 | 4,142µs | 11,229µs | 1.0 | 2,613µs | 1,529µs | 433 | ~0.95 MB (0.3%) | 31.03% |
| **IVF-316** | nprobe=4 | 341.5 | 11,689µs | 32,154µs | 4.0 | 8,019µs | 3,670µs | 1,579 | ~3.8 MB (1.3%) | 57.25% |
| **IVF-316** | nprobe=8 | 170.5 | 22,449µs | 54,809µs | 8.0 | 15,788µs | 6,661µs | 2,956 | ~7.6 MB (2.6%) | 69.30% |
| **IVF-316** | nprobe=16 | 110.2 | 36,258µs | 71,525µs | 16.0 | 25,786µs | 10,472µs | 5,628 | ~15.1 MB (5.2%) | 79.85% |
| **IVF-316** | nprobe=32 | 61.3 | 65,212µs | 108,919µs | 32.0 | 46,819µs | 18,393µs | 10,858 | ~30.2 MB (10.3%) | 88.39% |
| **IVF-316** | nprobe=64 | 39.4 | 101,510µs | 152,218µs | 64.0 | 72,352µs | 29,158µs | 21,035 | ~60.4 MB (20.6%) | **94.68%** |

### IVF nlist Comparison — Wikipedia 100K

| nlist | nprobe | QPS | Mean Latency | P95 Latency | IOs | Mean IO Time | Mean CPU Time | Mean Comps | Bytes Read (est.) | Recall |
|-------|--------|-----|-------------|-------------|-----|-------------|--------------|------------|-------------------|--------|
| **158** | 1 | 862.1 | 4,602µs | 14,462µs | 1.0 | 3,040µs | 1,562µs | 851 | ~1.9 MB (0.6%) | 37.79% |
| **316** | 1 | 962.5 | 4,142µs | 11,229µs | 1.0 | 2,613µs | 1,529µs | 433 | ~0.9 MB (0.3%) | 31.03% |
| **632** | 1 | 2,075.8 | 1,925µs | 3,725µs | 1.0 | 883µs | 1,042µs | 206 | ~0.5 MB (0.2%) | 25.06% |
| **158** | 4 | 251.9 | 15,766µs | 35,700µs | 4.0 | 11,151µs | 4,615µs | 3,107 | ~7.4 MB (2.5%) | 66.26% |
| **316** | 4 | 341.5 | 11,689µs | 32,154µs | 4.0 | 8,019µs | 3,670µs | 1,579 | ~3.7 MB (1.3%) | 57.25% |
| **632** | 4 | 936.0 | 4,270µs | 10,402µs | 4.0 | 2,381µs | 1,889µs | 782 | ~1.9 MB (0.6%) | 48.42% |
| **158** | 8 | 136.1 | 29,332µs | 55,102µs | 8.0 | 21,150µs | 8,182µs | 5,911 | ~14.9 MB (5.1%) | 77.70% |
| **316** | 8 | 170.5 | 22,449µs | 54,809µs | 8.0 | 15,788µs | 6,661µs | 2,956 | ~7.4 MB (2.5%) | 69.30% |
| **632** | 8 | 620.1 | 6,418µs | 13,974µs | 8.0 | 3,769µs | 2,649µs | 1,490 | ~3.7 MB (1.3%) | 60.62% |
| **158** | 16 | 71.4 | 55,349µs | 88,758µs | 16.0 | 40,272µs | 15,077µs | 11,303 | ~29.7 MB (10.1%) | 87.03% |
| **316** | 16 | 110.2 | 36,258µs | 71,525µs | 16.0 | 25,786µs | 10,472µs | 5,628 | ~14.9 MB (5.1%) | 79.85% |
| **632** | 16 | 343.3 | 11,637µs | 23,866µs | 16.0 | 7,325µs | 4,312µs | 2,839 | ~7.4 MB (2.5%) | 72.03% |
| **158** | 32 | 37.8 | 105,202µs | 150,215µs | 32.0 | 76,826µs | 28,376µs | 21,699 | ~59.4 MB (20.3%) | 93.87% |
| **316** | 32 | 61.3 | 65,212µs | 108,919µs | 32.0 | 46,819µs | 18,393µs | 10,858 | ~29.7 MB (10.1%) | 88.39% |
| **632** | 32 | 193.4 | 20,654µs | 35,659µs | 32.0 | 13,417µs | 7,237µs | 5,478 | ~14.8 MB (5.1%) | 81.98% |
| **158** | 64 | 20.0 | 198,525µs | 253,593µs | 64.0 | 145,260µs | 53,265µs | 41,671 | ~118.9 MB (40.6%) | **98.02%** |
| **316** | 64 | 39.4 | 101,510µs | 152,218µs | 64.0 | 72,352µs | 29,158µs | 21,035 | ~59.4 MB (20.3%) | 94.68% |
| **632** | 64 | 101.3 | 38,733µs | 59,015µs | 64.0 | 25,759µs | 12,974µs | 10,651 | ~29.7 MB (10.1%) | 89.97% |
