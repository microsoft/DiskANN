                        ...
                        const bool use_tags)
{
    ...
    diskann::Index<T, TagT, LabelT> index(
        metric, data_dim, data_num, std::make_shared<diskann::IndexWriteParameters>(index_build_params),
        index_build_params.search_list_size, 0, use_tags, use_tags, false, use_pq_build, num_pq_bytes, use_opq);
