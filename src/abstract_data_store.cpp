...
AbstractDataStore<data_t>::AbstractDataStore(const location_t capacity,
                                             const size_t dim)
...
template <typename data_t>
void AbstractDataStore<data_t>::preprocess_query(
    const data_t* query, AbstractScratch<data_t>* query_scratch) const {}

template<typename data_t>
void AbstractDataStore<data_t>::get_distance(const data_t *preprocessed_query,
                  const std::vector<location_t> &ids, std::vector<float> &distances,
