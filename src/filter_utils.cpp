...
//template DISKANN_DLLEXPORT tsl::robin_map<std::string, std::vector<_u32>> generate_label_specific_vector_files<float>(
//    path input_data_path, tsl::robin_map<std::string, _u32> labels_to_number_of_points,
//    std::vector<label_set> point_ids_to_labels, label_set all_labels);
//template DISKANN_DLLEXPORT tsl::robin_map<std::string, std::vector<_u32>> generate_label_specific_vector_files<uint8_t>(
//    path input_data_path, tsl::robin_map<std::string, _u32> labels_to_number_of_points,
//    std::vector<label_set> point_ids_to_labels, label_set all_labels);
//template DISKANN_DLLEXPORT tsl::robin_map<std::string, std::vector<_u32>> generate_label_specific_vector_files<int8_t>(
//    path input_data_path, tsl::robin_map<std::string, _u32> labels_to_number_of_points,
//    std::vector<label_set> point_ids_to_labels, label_set all_labels);
