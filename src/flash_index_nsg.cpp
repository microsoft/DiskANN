...
#define _CONTROL_NUM 100
  ...
  void FlashIndexNSG::Load(const char *filename) {
    this->graph_reader.open((std::string(filename) + ".nsg").c_str());
  ...
  void FlashIndexNSG::Load_nn_graph(const char *filename) {
  ...
  void FlashIndexNSG::get_neighbors(const float *query, const Parameters &parameter,
  ...
  void FlashIndexNSG::init_graph(const Parameters &parameters) {
  ...
  void FlashIndexNSG::init_graph_bf(const Parameters &parameters) {
...
#pragma omp parallel for schedule(static, 65536)
  ...
  void FlashIndexNSG::sync_prune(unsigned q, std::vector<Neighbor> &pool,
  ...
  void FlashIndexNSG::InterInsert(unsigned n, unsigned range,
  ...
  void FlashIndexNSG::Link(const Parameters &parameters,
                      SimpleNeighbor *  cut_graph_) {
...
#pragma omp for schedule(dynamic, 100)
  ...
  void FlashIndexNSG::Build(size_t n, const float *data,
  ...
  std::pair<int, int> FlashIndexNSG::BeamSearch(const float *query, const float *x,
                                           size_t            K,
                                           const Parameters &parameters,
  ...
  unsigned long long int FlashIndexNSG::SearchWithOptGraph(
  ...
  void FlashIndexNSG::OptimizeGraph(float *data) {  // use after build or load
  ...
  void FlashIndexNSG::DFS(tsl::robin_set<unsigned> &visited, unsigned root,
                     unsigned &cnt) {
    unsigned             tmp = root;
  ...
  void FlashIndexNSG::findroot(tsl::robin_set<unsigned> &visited, unsigned &root,
                          const Parameters &parameter) {
    unsigned id = nd_;
    for (unsigned i = 0; i < nd_; i++) {
  ...
  void FlashIndexNSG::tree_grow(const Parameters &parameter) {
    unsigned                 root = ep_;
    tsl::robin_set<unsigned> visited;
