...
DISKANN_DLLEXPORT std::unique_ptr<char[]>
get_file_content(const std::string &filename, uint64_t &file_size);
...
template <typename LabelT>
const std::vector<location_t> &
InMemFilterStore<LabelT>::get_medoids_of_label(const LabelT label) {
