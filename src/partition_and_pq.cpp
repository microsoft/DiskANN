...
template NSGDLLEXPORT void gen_random_slice<uint8_t>(const char *inputfile,
                                                     ...
                                                     size_t &    slice_size,
                                                     size_t &    ndims);
template NSGDLLEXPORT void gen_random_slice<int8_t>(const char *inputfile,
                                                    float       p_val,
                                                    float *&    sampled_data,
                                                    size_t &    slice_size,
                                                    size_t &    ndims);
template NSGDLLEXPORT void gen_random_slice<float>(const char *inputfile,
                                                   float       p_val,
                                                   float *&    sampled_data,
                                                   size_t &    slice_size,
                                                   size_t &    ndims);
...
template NSGDLLEXPORT void gen_random_slice<int8_t>(const int8_t *inputdata,
                                                    size_t npts, size_t ndims,
                                                    float   p_val,
                                                    float *&sampled_data,
                                                    size_t &slice_size);
template NSGDLLEXPORT void gen_random_slice<float>(const float *inputdata,
                                                   size_t npts, size_t ndims,
                                                   float   p_val,
                                                   float *&sampled_data,
                                                   size_t &slice_size);
