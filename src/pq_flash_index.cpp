                                                      ...
                                                      const char *pivots_filepath, const char *compressed_filepath)
{
    ...
    if (files.fileExists(labels_file))
    {
        ...
        std::stringstream infile(
            std::string((const char *) content_labels._content, content_labels._size));
#else
    if (file_exists(labels_file))
    {
        ...
        std::stringstream map_reader(
            std::string((const char *) content_labels_map._content, content_labels_map._size));
#else
        ...
        {
            FileContent      &content_labels_to_medoids = files.getContent(labels_to_medoids);
            std::stringstream medoid_stream(
                std::string((const char *) content_labels_to_medoids._content, content_labels_to_medoids._size));
#else
