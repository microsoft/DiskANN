...
template <typename T, typename LabelT>
std::pair<std::unique_ptr<ANNErrorCode>, LabelT> PQFlashIndex<T, LabelT>::get_converted_label(
...
template <typename T, typename LabelT>
std::unique_ptr<ANNErrorCode> PQFlashIndex<T, LabelT>::cached_beam_search(
