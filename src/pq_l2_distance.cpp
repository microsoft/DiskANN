...
PQL2Distance<data_t>::~PQL2Distance() {
#ifndef EXEC_ENV_OLS
  if (_tables != nullptr) delete[] _tables;
  if (_chunk_offsets != nullptr) delete[] _chunk_offsets;
  if (_centroid != nullptr) delete[] _centroid;
  if (_rotmat_tr != nullptr) delete[] _rotmat_tr;
#endif
  if (_tables_tr != nullptr) delete[] _tables_tr;
}
