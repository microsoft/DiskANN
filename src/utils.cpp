...
double
calculate_range_search_recall(uint32_t num_queries,
...
void copy_aligned_data_from_file(AlignedFileReader &reader, T *&data,
  ...
  if (data == nullptr) {
    ...
    throw diskann::ANNException(
        "Null pointer passed to copy_aligned_data_from_file()", -1, __FUNCSIG__,
        __FILE__, __LINE__);
  }
  ...
  while (i < npts) {
    ...
    for (int k = 0; k < read_requests.size(); k++) {
      if ((*ctx.m_pRequestsStatus)[k] != IOContext::READ_SUCCESS) {
        throw diskann::ANNException(
            "Load data from file using AlignedReader failed.", -1, __FUNCSIG__,
            __FILE__, __LINE__);
      }
    }
  }
...
load_bin<uint8_t>(AlignedFileReader &reader, std::unique_ptr<uint8_t[]> &data,
                  size_t &npts, size_t &ndim, size_t offset);
template DISKANN_DLLEXPORT void
load_bin<int8_t>(AlignedFileReader &reader, std::unique_ptr<int8_t[]> &data,
                 size_t &npts, size_t &ndim, size_t offset);
template DISKANN_DLLEXPORT void
load_bin<uint32_t>(AlignedFileReader &reader, std::unique_ptr<uint32_t[]> &data,
                   size_t &npts, size_t &ndim, size_t offset);
template DISKANN_DLLEXPORT void
load_bin<uint64_t>(AlignedFileReader &reader, std::unique_ptr<uint64_t[]> &data,
                   size_t &npts, size_t &ndim, size_t offset);
template DISKANN_DLLEXPORT void
load_bin<int64_t>(AlignedFileReader &reader, std::unique_ptr<int64_t[]> &data,
                  size_t &npts, size_t &ndim, size_t offset);
template DISKANN_DLLEXPORT void load_bin<float>(AlignedFileReader &reader,
                                                std::unique_ptr<float[]> &data,
                                                size_t &npts, size_t &ndim,
                                                size_t offset);

template DISKANN_DLLEXPORT void load_bin<uint8_t>(AlignedFileReader &reader,
                                                  uint8_t *&data, size_t &npts,
                                                  size_t &ndim, size_t offset);
template DISKANN_DLLEXPORT void load_bin<int64_t>(AlignedFileReader &reader,
                                                  int64_t *&data, size_t &npts,
                                                  size_t &ndim, size_t offset);
...
template DISKANN_DLLEXPORT void load_bin<int32_t>(AlignedFileReader &reader,
                                                  int32_t *&data, size_t &npts,
                                                  size_t &ndim, size_t offset);

template DISKANN_DLLEXPORT void
copy_aligned_data_from_file<uint8_t>(AlignedFileReader &reader, uint8_t *&data,
                                     size_t &npts, size_t &dim,
                                     const size_t &rounded_dim, size_t offset);
template DISKANN_DLLEXPORT void
copy_aligned_data_from_file<int8_t>(AlignedFileReader &reader, int8_t *&data,
                                    size_t &npts, size_t &dim,
                                    const size_t &rounded_dim, size_t offset);
template DISKANN_DLLEXPORT void
copy_aligned_data_from_file<float>(AlignedFileReader &reader, float *&data,
                                   size_t &npts, size_t &dim,
                                   const size_t &rounded_dim, size_t offset);
...
template DISKANN_DLLEXPORT void read_array<int8_t>(AlignedFileReader &reader,
                                                   ...
                                                   size_t offset);
template DISKANN_DLLEXPORT void read_array<uint32_t>(AlignedFileReader &reader,
                                                     uint32_t *data,
                                                     size_t size,
                                                     size_t offset);
...
template DISKANN_DLLEXPORT void
read_value<uint8_t>(AlignedFileReader &reader, uint8_t &value, size_t offset);
template DISKANN_DLLEXPORT void
read_value<int8_t>(AlignedFileReader &reader, int8_t &value, size_t offset);
template DISKANN_DLLEXPORT void read_value<float>(AlignedFileReader &reader,
                                                  float &value, size_t offset);
template DISKANN_DLLEXPORT void
read_value<uint32_t>(AlignedFileReader &reader, uint32_t &value, size_t offset);
template DISKANN_DLLEXPORT void
read_value<uint64_t>(AlignedFileReader &reader, uint64_t &value, size_t offset);
