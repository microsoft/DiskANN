...
./build/tests/search_memory_index float /mnt/aditi/tmp-incr-${1}-${2}.nsg.reinc.data /mnt/aditi/tmp-incr-${1}-${2}.nsg.reinc.data /mnt/SIFT1M/sift_query.bin 5 8 /mnt/aditi/tmp-incr-${1}-${2}_ 8

./build/tests/utils/calculate_recall /mnt/aditi/gs_100_tmp-incr-${1}-${2}.nsg.reinc.data /mnt/aditi/tmp-incr-${1}-${2}_8_idx_uint32.bin 5
