...
void block_convert_float(std::ifstream &reader, std::ofstream &writer, _u64 npts, _u64 ndims)
{
...
void block_convert_int8(std::ifstream &reader, std::ofstream &writer, _u64 npts, _u64 ndims)
{
...
void block_convert_uint8(std::ifstream &reader, std::ofstream &writer, _u64 npts, _u64 ndims)
{
